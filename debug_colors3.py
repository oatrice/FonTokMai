...
for i in range(50):
    ...
    label = "UNKNOWN"
    if min_dist_ignore < min_dist_rain and min_dist_ignore < 25:
        label = "IGNORE"
    elif min_dist_rain < min_dist_ignore and min_dist_rain < 25:
        label = "RAIN"
        
    print(f"Color: {c}, Count: {counts[i]}, Dist Ignore: {min_dist_ignore:.1f}, Dist Rain: {min_dist_rain:.1f}, Label: {label}")
