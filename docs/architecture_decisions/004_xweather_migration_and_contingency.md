...
- **Core Fallback Strategy:** ระบบ `WeatherManager` (ที่ถูกออกแบบมาเป็น Chain of Responsibility) จะสลับการทำงานกลับไปดึงข้อมูลฝนจาก **Tomorrow.io** (Minutecast fallback) และ **Rainbow.ai** (Global fallback) โดยอัตโนมัติ เพื่อให้ผู้ใช้ยังคงได้รับการเตือนฝนตกพื้นฐาน
